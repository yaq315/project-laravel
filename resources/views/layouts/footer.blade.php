  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-4 col-md-8 mb-4 mb-xl-0 single-footer-widget">
        <h4>Newsletter</h4>
        <p>Subscribe to our newsletter to get the latest updates on our adventures and special offers.</p>
    ...
    <div class="footer-bottom row align-items-center text-center text-lg-left">
      <p class="footer-text m-0 col-lg-8 col-md-12">
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | RumQuest
      </p>
